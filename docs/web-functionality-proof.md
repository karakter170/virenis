...
6. Generic Marketing guidance did not reliably select the terminal lead. Its semantic cues now include natural “where should I start,” “how should I begin,” and “guide my marketing” phrasings; Qwen remains the primary selector and deterministic logic remains bounded fallback.
7. Capability arithmetic could block ordinary follow-ups such as “look at other perspectives.” Selection is now model-led across the active team, while deterministic checks enforce identity, lifecycle, permissions, exact typed handoffs, and required dependency closure instead of vetoing qualitative wording.
